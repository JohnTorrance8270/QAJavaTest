...
public class OutputController 
{
	...
	public static void chestOpenResponse()
	{
		int messageLength = 2;
		String[] chestOpenMessage = new String[messageLength];
		
		if(didItGoWell())
		{
			chestOpenMessage[0] = "You were able to get the chest!";
			chestOpenMessage[1] = "Sadly, nothing was inside...";	
		}
		else
		{
			chestOpenMessage[0] = "You failed to get the chest";
			chestOpenMessage[1] = "you watch as it sinks deeper into the mud, away from reach";	
		}
		
		outputMessage(chestOpenMessage);
	}
	
	public static void pathTraveledResponse()
	{
		int messageLength = 1;
		String[] chestOpenMessage = new String[messageLength];
		...
		if(didItGoWell())
		{
			chestOpenMessage[0] = "The path chosen was smooth and comfortable";
		}
		else
		{
			chestOpenMessage[0] = "The path picked was a nightmare, slowly you get through it, just";
		}
